...
export const MisionVision = () => {
  return (
    <section className="py-20 px-4 bg-gradient-to-b from-ivory to-rosegold/10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2
            className={`${fontLust.className} antialiased text-4xl font-extrabold md:text-5xl text-primary mb-6`}
          >
            Nuestro Propósito
          </h2>
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <h3
                      className={`${fontLust.className} antialiased text-2xl md:text-3xl font-bold`}
                    >
                      {item.title}
                    </h3>
                  </div>
